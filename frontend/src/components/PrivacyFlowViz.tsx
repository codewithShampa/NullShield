...
/**
 * PrivacyFlowViz component - auto-documented
 */
export default function PrivacyFlowViz({ status }: { status: VerifyStatus }) {
  const steps = [
    { 
      ...
      sublabel: 'Vote choice stays on device', 
      icon: <Lock size={24} />, 
  ...
  return (
    <div className="card privacy-viz-card transition-all duration-300 ease-in-out">
      ...
      <div className="privacy-notice">
        ...
        <span><strong>Your actual vote choice is never sent to the network.</strong> The Midnight blockchain only records a cryptographic proof that you cast a valid ballot, and increments the public tally — your choice remains totally private.</span>
      </div>
    </div>
  );
}
