...
/**
 * WalletBanner component - auto-documented
 */
export default function WalletBanner() {
  ...
  if (walletStatus === 'checking') {
    return (
      <div className="wallet-pill loading transition-all duration-300 ease-in-out">
  ...
  if (isConnected && address) {
    return (
      <div className="wallet-pill connected">
        ...
        <button type="button" className="btn-icon" onClick={disconnect} title="Disconnect Wallet">
          ✕
        </button>
      </div>
    );
