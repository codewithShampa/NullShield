...
/**
 * AnalyticsCard component - auto-documented
 */
export const AnalyticsCard: React.FC<AnalyticsCardProps> = ({
  ...
  const downloadReceipt = () => {
    ...
    downloadAnchor.setAttribute('download', `NullShield_Receipt_${latestReceipt.proposalId}_${Date.now()}.json`);
  ...
  return (
    <div className="card-cyber rounded-2xl p-6 relative overflow-hidden border border-cyan-500/20 bg-[#070b14]/90 backdrop-blur-xl shadow-2xl transition-all duration-300 ease-in-out">
      <div className="flex items-center justify-between pb-4 border-b border-cyan-500/10 mb-6">
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-xl bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 antialiased tracking-tight">
      ...
      {latestReceipt && (
        <div className="p-4 rounded-xl bg-cyan-950/20 border border-cyan-500/30 flex items-center justify-between">
          ...
          <button type="button"
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-cyan-500/20 hover:bg-cyan-500/30 border border-cyan-500/40 text-cyan-300 text-xs font-semibold transition focus:outline-none focus:ring-2 focus:ring-primary/50"
          >
